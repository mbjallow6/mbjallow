---
title: Latest Test Decap Blog Test
description: A person with short, thick hair and prescription glasses sits at an
  organized workstation
published: 2025-09-30T00:31:00.000+02:00
author: MB Jallow
tags:
  - blog Test
series: Test Series
...
![Pixel art of a tree](https://images.unsplash.com/photo-1428606381429-22224991fb0c 'Pixel art renders poorly without proper CSS')

```md title="Pixel art markdown" wrap
![Pixel art of a tree](# 'Pixel art renders poorly without proper CSS')
```
