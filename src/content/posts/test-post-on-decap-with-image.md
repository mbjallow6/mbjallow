---
title: Test Post on Decap With Image
published: 2025-09-30T00:46:00.000+02:00
author: MBJallow
coverImage: https://images.unsplash.com/photo-1427830574887-32e5702033b0
coverImageAlt: A person with short, thick hair and prescription glasses sits at
  an organized workstation
tags:
  - Test
  - Blog
  - Decap
series: Decap Serries
draft: false
toc: true
---
...
![Pixel art of a tree](https://images.unsplash.com/photo-1427830574887-32e5702033b0 'Pixel art renders poorly without proper CSS')
...
![Pixel art of a tree #pixelated](https://images.unsplash.com/photo-1429042007245-890c9e2603af 'But adding #pixelated to the end of the alt string fixes this')

```md title="Pixel art markdown with #pixelated" wrap
![Pixel art of a tree #pixelated](https://images.unsplash.com/photo-1446769826264-5cbbaf7aa895 'But adding #pixelated to the end of the alt string fixes this')
```
